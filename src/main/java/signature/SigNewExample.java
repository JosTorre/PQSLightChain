...
public class SigNewExample {
    ...
    public static void main(String[] args) {
        ...
        byte[] message = "Ich bin Jose Torre".getBytes();

        String sig_name = "Falcon-1024";
	...
	System.out.println("Signer secret key:");
	System.out.println(Common.to_hex(signer.export_secret_key()));
	System.out.println();

	System.out.println("Signer public key:");
        System.out.println(Common.to_hex(signer_public_key));
	...
	System.out.println();
        ...
        System.out.println("\nSignature:");
        System.out.println(Common.to_hex(signature));
